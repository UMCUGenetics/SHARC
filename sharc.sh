...
cat << EOF >> $PRIMER_DESIGN_SH
    bash $STEPSDIR/primer_design.sh -f $VCF_FASTA_OUT -pdb $PRIMER_DESIGN_BINDIR -pdpt $PRIMER_DESIGN_PCR_TYPE -pdp $PRIMER_DESIGN_PSR -pdpc $PRIMER_DESIGN_PRIMER3_CORE -pdm $PRIMER_DESIGN_MISPRIMING
EOF
else
cat << EOF >> $PRIMER_DESIGN_SH
    bash $STEPSDIR/primer_design.sh -f $VCF_FASTA_OUT -pdb $PRIMER_DESIGN_BINDIR -pdpt $PRIMER_DESIGN_PCR_TYPE -pdtp $PRIMER_DESIGN_TILLING_PARAMS -pdp $PRIMER_DESIGN_PSR -pdpc $PRIMER_DESIGN_PRIMER3_CORE -pdm $PRIMER_DESIGN_MISPRIMING
EOF
fi
cat << EOF >> $PRIMER_DESIGN_SH
