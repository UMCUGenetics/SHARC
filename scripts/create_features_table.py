...
features = "id hp_distance1 hp_distance2 sr_distance1 sr_distance2 gap_distance1 gap_distance2 svlength mapq1 mapq2 pid1 pid2 cipos1 cipos2 plength1 plength2 ciend1 ciend2 rlength gap dr1 dr2 dv1 dv2".split()
print( "\t".join(features) )
...
for record in vcf_reader:
    ...
    feature_values.extend(record.INFO['HOMOPOLYMER_DISTANCE'])
